...
- **`CONTEXT.md`** at the repo root — the project's domain glossary and bounded-context overview.
...
If the concept you need isn't in the glossary yet, that's a signal — either you're inventing language the project doesn't use (reconsider) or there's a real gap (note it explicitly in your output).
